            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-gray-50/50 border-b border-gray-100">
                        <tr>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-gray-400">Driver Profile</th>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-gray-400">Email Address</th>
                            <th class="px-6 py-4 text-xs font-bold uppercase tracking-widest text-gray-400">Date Joined</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/30 transition-colors group">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-2xs text-gray-400 uppercase tracking-tighter">ID: #{{ $driver->id }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-700 font-medium">{{ $driver->created_at->format('M d, Y') }}</div>
                                <div class="text-2xs text-gray-400 uppercase">{{ $driver->created_at->format('h:i A') }}</div>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-xs text-gray-400 mt-1">Try adjusting your search filters or add a new account.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
