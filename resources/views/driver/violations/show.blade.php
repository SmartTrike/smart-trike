...
<div class="min-h-screen bg-gray-50/30 p-4 lg:p-10">
    <div class=" mx-auto">
        <a href="{{ route('driver.violations') }}" class="inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-gray-700 mb-6 transition-colors">
        ...
        <div class="bg-white border border-gray-100 rounded-3xl shadow-sm overflow-hidden">
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-lg font-bold text-gray-700">
                            {{ $violation->suspension_start_date->format('M d, Y') }} — {{ $violation->suspension_end_date->format('M d, Y') }}
                        </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-3 text-xs text-gray-400">Recorded by: Administrator {{ $violation->filer->username ?? 'System' }}</p>
                </div>
                ...
                <div>
                    ...
                    <div class="rounded-2xl overflow-hidden border border-gray-200">
                        <img src="{{ asset('storage/' . $violation->report->evidence_image_path) }}" class="w-full object-cover max-h-96">
                    </div>
                </div>
                @endif
            </div>
        ...
        <div class="mt-8 p-6 bg-blue-50 rounded-2xl border border-blue-100 flex items-start gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-blue-700 mt-1 leading-relaxed">If you believe this violation was issued in error, please visit the main office with your Case ID: #VL-{{ str_pad($violation->id, 5, '0', STR_PAD_LEFT) }}.</p>
            </div>
        </div>
    </div>
</div>
