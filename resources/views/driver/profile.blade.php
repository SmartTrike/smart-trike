...
@section('content')
        ...
        <div class="max-w-4xl mx-auto my-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <section class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div
                            class="flex flex-col md:flex-row items-center gap-8 p-6 bg-white rounded-xl border border-gray-100 ">
                            ...
                            <div class="flex-1">
                                <form action="{{ route('driver.updatePhoto') }}" method="POST"
                                    enctype="multipart/form-data" class="flex flex-col space-y-4">
                                    @csrf
                                    <div>
                                        <label class="block text-sm font-bold text-gray-700 mb-1">Update Profile
                                            Photo</label>
                        ...
                        <div>
                            ...
                            <p class="text-gray-900 font-semibold text-lg">{{ $driverInfo->first_name }}
                                {{ $driverInfo->last_name }}</p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700 font-medium">
                                    {{ $driverInfo->license_expiry_date ? \Carbon\Carbon::parse($driverInfo->license_expiry_date)->format('M d, Y') : '—' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section class="space-y-6">
                    ...
                    <div class="bg-gray-50 rounded-2xl p-6 space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span
                                class="font-mono font-bold text-gray-900 bg-white px-2 py-1 border border-gray-200 rounded shadow-sm">{{ $driverInfo->plate_number ?? 'N/A' }}</span>
                        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <input type="text" name="first_name"
                value="{{ old('first_name', $driverInfo->first_name) }}"
        ...
        <div>
            ...
            <input type="text" name="middle_name"
                value="{{ old('middle_name', $driverInfo->middle_name) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
                @error('middle_name') border-red-500 @enderror">
            @error('middle_name')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="last_name"
                value="{{ old('last_name', $driverInfo->last_name) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
        ...
        <div>
            ...
            <input type="text" name="suffix"
                value="{{ old('suffix', $driverInfo->suffix) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
                @error('suffix') border-red-500 @enderror">
            @error('suffix')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="contact_number"
                value="{{ old('contact_number', $driverInfo->contact_number) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
        ...
        <div>
            ...
            <input type="date" name="birthdate"
                value="{{ old('birthdate', $driverInfo->birthdate) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
        ...
        <div>
            ...
            <input type="date" name="license_expiry_date"
                value="{{ old('license_expiry_date', $driverInfo->license_expiry_date) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
                @error('license_expiry_date') border-red-500 @enderror">
        ...
        <div>
            ...
            <input type="text" name="plate_number"
                value="{{ old('plate_number', $driverInfo->plate_number) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
                @error('plate_number') border-red-500 @enderror">
            @error('plate_number')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="tricycle_body_number"
                value="{{ old('tricycle_body_number', $driverInfo->tricycle_body_number) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
                @error('tricycle_body_number') border-red-500 @enderror">
            @error('tricycle_body_number')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="text" name="model"
                value="{{ old('model', $driverInfo->model) }}"
                class="mt-1 w-full rounded-md shadow-sm border-gray-300 
    ...
    <div class="mt-8 flex justify-end">
        <button type="submit"
            class="bg-blue-600 text-white px-8 py-2 rounded-md font-semibold hover:bg-blue-700 transition">
            Save Profile Changes
                ...
                <div class="bg-white shadow rounded-lg  p-4">
                    ...
                    <p class="text-sm text-gray-500 mb-6">Ensure your account is using a long, random password to stay
                        secure.</p>
                    ...
                    <form action="{{ route('driver.passwordUpdate') }}" method="POST">
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit"
                                class="bg-gray-800 text-white px-8 py-2 rounded-md font-semibold hover:bg-black transition">Update
                                Password</button>
                        </div>
                    </form>
                </div>
