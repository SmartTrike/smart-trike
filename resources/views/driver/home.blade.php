    ...
    <div class="min-h-screen bg-white  md:bg-gray-50/30  p-4 lg:p-10">
        <div class="max-w-4xl mx-auto my-auto ">
            ...
            <div class="mb-10">
                ...
                {{-- <form action="{{ route('driver.checkin') }}" method="POST">
                    @csrf
                 <button>
                       Check In
                 </button>
                ...
                @if ($onRide)
                    <div
                        class="bg-blue-50 border border-blue-100 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <form method="POST" action="{{ route('driver.completeRide', $currentRide->id) }}"
                            class="w-full md:w-auto">
                            @csrf
                            <button type="submit"
                                class="w-full px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700">
                                Complete Ride
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="bg-amber-50 border border-amber-100 rounded-2xl p-6">
                        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                            ...
                            <button id="start-scan"
                                class="w-full md:w-auto px-8 py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-black transition-all active:scale-95 shadow-lg shadow-gray-200 flex items-center justify-center gap-2">
                        ...
                        <div id="qr-reader-container" class="mt-6 hidden">
                            ...
                            <button id="stop-scan"
                                class="mt-4 w-full text-sm font-bold text-red-600 uppercase tracking-widest">Cancel
                                Scan</button>
                        </div>
