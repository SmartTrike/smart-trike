            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="text-[10px] uppercase font-bold text-gray-400 tracking-widest">Violation
                                    Type</label>
                                <p class="text-gray-900 font-medium">{{ $violation->violation }}</p>
                            </div>

                            <div>
                                <label class="text-[10px] uppercase font-bold text-gray-400 tracking-widest">Administrative
                                    Remarks</label>
                                <div
                                    class="mt-1 p-4 bg-gray-50 rounded-xl text-sm text-gray-700 leading-relaxed border border-gray-100">
                    ...
                    @if ($violation->report && $violation->report->evidence_image_path)
                        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
                            ...
                            <img src="{{ Cloudinary::getImage($violation->report->evidence_image_path)->delivery('q_auto')->delivery('f_auto')->resize('limit', 1024)->toUrl() }}"
                                alt="Evidence" class="w-full h-auto rounded-xl border border-gray-100 shadow-inner">
                        </div>
                    @endif
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="h-12 w-12 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 font-bold border border-gray-200">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-700">
                                        {{ $violation->suspension_start_date?->format('F d, Y') ?? 'N/A' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-gray-700">
                                        {{ $violation->suspension_end_date?->format('F d, Y') ?? 'N/A' }}</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-700">{{ $violation->filer->username ?? 'System' }}
                                </p>
                                <p class="text-[10px] text-gray-400">{{ $violation->created_at->format('M d, Y @ h:i A') }}
                                </p>
                            </div>
                        </div>
                    </div>
