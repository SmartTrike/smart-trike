        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden p-8">
            <form action="{{ route('storeNewReport') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        <label for="evidence_image_path" class="block text-sm font-semibold text-gray-700">
                            Evidence Image
                        </label>
                        ...
                        <input
                            ...
                            name="evidence_image_path"
                            accept="image/*"
                            class="mt-2 block w-full text-sm text-gray-700 border border-gray-300 rounded-md p-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>

                    <div>
                        <label for="remarks" class="block text-sm font-semibold text-gray-700">Additional Remarks <span class="text-gray-400 font-normal"></span></label>
