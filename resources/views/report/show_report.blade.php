    ...
    <div class="max-w-5xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-mono font-bold text-gray-900">#{{ str_pad($report->id, 5, '0', STR_PAD_LEFT) }}</span>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-3xl shadow-sm overflow-hidden">
            <div class="p-8 border-b border-gray-50 bg-gray-50/30">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div>
                        ...
                        @endphp
                        <span class="px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest {{ $statusColors[$report->status] ?? 'bg-gray-100' }}">
                            {{ $report->status }}
                        </span>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                <div class="lg:col-span-2 p-8 space-y-8">
                    <div>
                        <h3 class="text-sm font-bold text-gray-400 uppercase tracking-widest mb-3">Incident Description</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-gray-400 uppercase tracking-widest mb-3">Incident Timing</h3>
                            <div class="p-3 border border-gray-100 rounded-2xl space-y-1">
                                <div class="text-sm font-bold text-gray-900">{{ \Carbon\Carbon::parse($report->event_date)->format('F j, Y') }}</div>
                                <div class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($report->event_date)->format('h:i A') }} (Local Time)</div>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($report->remarks)
                    <div>
                        <h3 class="text-sm font-bold text-gray-400 uppercase tracking-widest mb-3">Admin Remarks</h3>
                ...
                <div class="p-8 bg-gray-50/20">
                    ...
                    <div class="rounded-2xl overflow-hidden border border-gray-200 shadow-sm">
                        <img src="{{ asset('storage/' . $report->evidence_image_path) }}" class="w-full h-auto object-cover hover:scale-105 transition-transform duration-500" alt="Evidence">
                    </div>
                    <a href="{{ asset('storage/' . $report->evidence_image_path) }}" target="_blank" class="mt-4 flex items-center justify-center text-xs font-bold text-blue-600 hover:text-blue-800 transition-colors">
                    ...
                    @else
                    <div class="rounded-2xl border-2 border-dashed border-gray-200 h-48 flex flex-col items-center justify-center text-gray-400">
            ...
            <div class="p-8 bg-white border-t border-gray-100 flex flex-wrap gap-4 justify-between items-center">
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    {{-- Approve Button --}}
                    <a href="{{ route('violation.create', ['report_id' => $report->id]) }}" class="px-6 py-2.5 bg-green-600 text-white rounded-xl text-sm font-bold hover:bg-green-700 shadow-lg shadow-green-100 transition-all flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
