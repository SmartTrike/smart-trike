...
@section('content')
    <div class="min-h-screen bg-gray-50/30 p-4 lg:p-10">
        <div class="max-w-6xl mx-auto">
            ...
            @if (session('success'))
                <div class="mb-6 flex items-center p-4 bg-green-50 border-l-4 border-green-500 rounded-r-xl shadow-sm animate-fade-in-down">
                                        ...
                                        <div class="flex items-center gap-3">
                                            @if ($report->evidence_image_path)
                                                ...
                                                <x-cloudinary::image 
                                                    ...
                                                    height="100" 
                                                    crop="thumb"
                                                    public-id="{{ $report->evidence_image_path }}"
